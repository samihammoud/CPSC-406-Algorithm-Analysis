...
\subsubsection*{Exercise 5 (Landau notation --- sorting)}
...
\subsubsection*{Question}
For $L_3$, the bound $k$ is what makes the problem decidable. If I removed $k$ and only asked whether $M$ halts on $w$ at all, is there any way to still get a decider by ``simulating longer and longer'' without cheating---or is that exactly why $L_2$ stays undecidable?
