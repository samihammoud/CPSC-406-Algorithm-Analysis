...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \IfFileExists{ex2-dfa.png}{\includegraphics[width=0.85\textwidth]{ex2-dfa.png}}{\fbox{\parbox{0.8\textwidth}{\centering [Insert intersection automaton $\mathcal{B}$ diagram as \texttt{ex2-dfa.png} if desired]}}}
    \caption{Intersection automaton $\mathcal{B}$ (hand-drawn diagram).}
    \label{fig:ex2dfa}
  \end{figure}
