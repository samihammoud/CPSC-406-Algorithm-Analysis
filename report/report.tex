...
\subsubsection*{Question}
When I argue something is decidable vs.\ only r.e., what is the key difference in the machine behavior I'm relying on? Like, is it basically always ``will it halt on the reject cases''?
