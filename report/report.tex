...
\subsubsection*{Question}
When I do these induction proofs for recurrences, I always get stuck picking constants $c$ and the base threshold. Is there a reliable way to choose them fast without trial-and-error every single time?
