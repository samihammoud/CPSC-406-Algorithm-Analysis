...
\begin{figure}[H]
  ...
  \caption{Handwritten notes: language rules for $\mathcal{B}^{(1)}$ (e.g.\ include 3 $a$'s at a time, any amount of $b$'s) and $\mathcal{B}^{(2)}$ (e.g.\ $b$ must follow an $a$, any amount of $b$'s), and DFA diagram for language 2.}
  \label{fig:ex2notes}
\end{figure}
...
\begin{enumerate}
  ...
  \textbf{Answer:}
  $L(\mathcal{B}^{(1)})$ can accept any amount of $b$. (See handwritten notes and diagram below for full description of both languages.)
