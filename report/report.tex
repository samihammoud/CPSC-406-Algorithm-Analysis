...
\subsubsection*{Question}
When I'm stuck on satisfiability, is it usually faster for me to brute-force the truth table (like for $\psi_1$) or try unit propagation / chaining implications first---and how do I know which one won't blow up?
