...
\subsubsection*{Question}
When I use the recursion tree I feel like I'm just drawing pictures---how do I know when the tree guess is actually tight enough that substitution won't fight me (like that annoying $\frac{5}{4}c$ mismatch in 4.4-5)?
